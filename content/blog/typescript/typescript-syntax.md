...
> 📌 `private`, `public`, `protected`의 차이<br /> > <br /> > `private` : private로 선언한 클래스 내에서만 접근할 수 있으며, 상속을 받은 클래스 및 인스턴스는 접근할 수 없다<br /> > `public` : 상속을 받은 클래스 및 인스턴스에서 자유롭게 접근할 수 있다<br /> > `protected` : 상속을 받은 클래스 내에서는 접근할 수 있지만 인스턴스에서는 접근할 수 없다<br /> > <br />
